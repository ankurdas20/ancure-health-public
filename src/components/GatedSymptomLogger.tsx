...
interface GatedSymptomLoggerProps {
  onLogSuccess?: () => void;
}

export function GatedSymptomLogger({ onLogSuccess }: GatedSymptomLoggerProps) {
  const { user, isInitialized, initializeAuth } = useLazyAuth();
      ...
      <Card variant="soft" className="overflow-hidden border border-border/50">
        ...
        <CardContent>
          <LockedFeatureOverlay
            ...
            description="Sign in to track daily symptoms and see patterns over time."
