...
export function AuthPage() {
  ...
  const { signInWithMagicLink, initializeAuth } = useLazyAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Initialize auth when user tries to sign in
  ...
  return (
    <div className="min-h-screen gradient-hero">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <motion.div 
          className="absolute bottom-40 left-10 w-64 h-64 bg-secondary/15 rounded-full blur-3xl"
            ...
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-base">
                {emailSent 
                  ...
                  : 'Sign in with your email to save your cycle data across devices'
                }
              </CardDescription>
            </CardHeader>
            <CardContent>
