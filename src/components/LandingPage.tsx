...
import { ArrowRight, Shield, Heart, Sparkles, Calendar, Wifi, WifiOff } from 'lucide-react';
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        >
          <p className="text-xs text-muted-foreground max-w-md mx-auto px-4">
            ⚕️ This tool provides educational estimates only and is not a medical diagnosis or medical advice. 
