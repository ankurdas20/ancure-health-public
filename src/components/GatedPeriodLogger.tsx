...
interface GatedPeriodLoggerProps {
  currentLastPeriodDate: string;
  onLogPeriod: (date: string) => void;
}

export function GatedPeriodLogger({ currentLastPeriodDate, onLogPeriod }: GatedPeriodLoggerProps) {
      ...
      <Card variant="soft" className="overflow-hidden border border-border/50">
        ...
        <CardContent>
          <LockedFeatureOverlay
            ...
            description="Sign in to log your period and improve prediction accuracy."
